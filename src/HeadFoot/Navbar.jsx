...
export default function Navbar() {
  ...
  return (
    ...
    >
        ...
        {/* Mobile Sidebar */}
      {/* <div className={`fixed top-22 right-0 h-full w-[100%] sm:w-[100%] bg-[#6f4e37]  z-40 transform transition-transform duration-1000 ease-in-out ${
          isOpen ? "translate-x-0" : "translate-x-full" }`} >
        
        <ul className="flex flex-col gap-6 px-8  text-white font-semibold text-lg list-none  bg-[#6f4e37] py-4" >
          
          <li onClick={handleClose} className="hover:text-coffee-gold cursor-pointer">
            HOME
          </li>
          <li onClick={handleClose} className="hover:text-coffee-gold cursor-pointer">
            ABOUT
       ...
       {/* Mobile Sidebar */}
<div
  className={`fixed top-22 right-0 h-full w-full bg-[#6f4e37] z-[99999]
...
>
  <ul className="flex flex-col gap-6 px-8 text-white font-semibold text-lg py-4  bg-[#6f4e37]">
    ...
    <li>
      <NavLink to="/beans" onClick={handleClose}>
        BEANS
      </NavLink>
    </li>

    <li>
      <NavLink to="/health" onClick={handleClose}>
        HEALTH
      </NavLink>
    </li>

    <li>
      <NavLink to="/sustainability" onClick={handleClose}>
        SUSTAINABILITY
      </NavLink>
    </li>
