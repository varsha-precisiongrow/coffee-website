...
const Footer = () => {
  return (
   <footer
  className="text-gray-300 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${footerBg})`, }} >
      {/* Newsletter Section */}
      <div className="max-w-7xl mx-auto px-6 py-10 border-b border-gray-700">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex w-full md:w-auto">
            <input type="email"  placeholder="Your Email Address" className="w-full md:w-72 px-4 py-2 bg-gray-800 text-white outline-none"/>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Our Services */}
        <div>
          <h3 className="relative inline-block font-semibold mb-4 text-[#d6b08c] overflow-hidden">OUR ADDRESS
        ...
        <li>
          <Link to="/about" className="hover:text-[#c4a484] transition duration-300" > About Us </Link>
        </li>
        <li>
          <Link to="/beans" className="hover:text-[#c4a484] transition duration-300" >Beans </Link>
        </li>
        <li>
          <Link to="/health" className="hover:text-[#c4a484] transition duration-300" >Health</Link>
        </li>
        <li>
          <Link to="/story" className="hover:text-[#c4a484] transition duration-300" > Our Story </Link>
        </li>
        <li>
          <Link to="/sustainability" className="hover:text-[#c4a484] transition duration-300" > Sustainability</Link>
        </li>
      </ul>
        </div>
        {/* Opening Hours */}
