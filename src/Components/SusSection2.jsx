...
export default function SusSection2() {
  ...
  return (
    ...
    >
      <img
        src={bgImg}
        alt="Our Commitment" loading="lazy"
      ...
      <motion.div
        style={{ y }}
        className="relative z-10 max-w-5xl px-6 md:px-10 text-center"
      >
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl sm:text-4xl md:text-8xl font-bold mb-6 uppercase text-[#603913]"
        >
          Our Commitment
        </motion.h2>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-900"
        >
