    ...
    <section className="w-full bg-[#fdf8f3] px-4 sm:px-6 md:px-10 lg:px-10 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          >
            Coffee is more than just a comforting daily drink. Backed by years of
            scientific research, coffee has been associated with improved brain
            function, increased energy, reduced risk of chronic diseases, and
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <motion.h4
              ...
              viewport={{ once: true }}
              custom={4}
              className="text-3xl sm:text-4xl font-bold text-[#3b2416] leading-tight mb-6"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              custom={5}
              className="text-gray-600 leading-relaxed text-base sm:text-lg mb-5"
            >
              Coffee contains naturally occurring compounds including caffeine,
              antioxidants, and anti-inflammatory elements that may support both
            ...
            >
              Research from global health organizations and scientific studies
              continues to show positive associations between moderate coffee
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            custom={7}
            className="bg-white rounded-3xl p-8 shadow-xl border border-[#f1e4d8]"
          >
            <motion.h5
              variants={fadeUp}
              initial="hidden"
              ...
              viewport={{ once: true }}
              custom={8}
              className="text-2xl font-bold text-[#3b2416] mb-6"
            >
