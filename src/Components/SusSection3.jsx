    ...
    <section className="w-full bg-[#f4efe9] font-serif relative overflow-hidden relative">
     <img src="https://api.ecrop.co/assets/precisiongrow/cdnassets/coffe3.webp" alt="coffee3" loading="lazy" className="absolute -left-4 -bottom-8 w-96 hidden lg:block" />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="space-y-5 " >
        <motion.h3 variants={item} className="text-3xl md:text-4xl font-bold text-[#603913] mb-6" >
        ...
        {/* RIGHT IMAGE */}
        <motion.div style={{ x: xRight, opacity }} className="w-full md:w-1/2 flex justify-center">
          <img src={section3img} alt="Sustainable Coffee" className="w-full max-w-sm md:max-w-full h-auto md:h-full object-cover" />
        </motion.div>
      </div>
    </section>
  );
