...
{/* ====================================================================== banner section =============================================================== */}
      ...
      <section className="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-96">
        ...
        {/* Background Image */}
        <img
          src="two-coffee-cups-clicking.jpg"
          alt="Coffee Banner"
          loading="lazy"
...
{/* ====================================================================== coffee section =============================================================== */}
      ...
      <section className="relative w-full bg-[#fdf8f3] py-14 px-4 sm:px-6 md:px-10 lg:px-20 pr-40 xl:pr-60 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Content */}
          <div>
            <p className="text-[#6f4e37] uppercase tracking-[3px] text-sm font-semibold mb-3">
              Coffee & Wellness
            </p>

            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#3b2416] leading-tight mb-6">
              More Than Just a Morning Drink
            </h3>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-5">
              Coffee is a naturally grown beverage made from coffee cherries
              that grow on trees. Loved for centuries across the world,
              coffee is now one of the most enjoyed and researched drinks globally.
            </p>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-8">
              Research from health experts and global studies suggests that
              coffee may support overall wellness by improving focus,
              boosting energy, and helping reduce the risk of several
            ...
            <div className="bg-white border-l-4 border-[#6f4e37] p-5 rounded-xl shadow-md">
              <p className="text-gray-700 italic text-sm sm:text-base leading-relaxed">
                “Studies involving millions of people worldwide show that
                coffee can support cognitive health, physical performance,
                and long-term wellness. Moderate coffee consumption has
                been linked with healthier and longer lives.”
              </p>

              <h4 className="mt-4 text-[#3b2416] font-semibold text-sm sm:text-base">
                — Farin Kamangar, MD, PhD
              </h4>

              <p className="text-gray-500 text-sm">
                Morgan State University & NCA Medical Advisor
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-lg hover:-translate-y-2 transition duration-300 border border-[#f1e4d8]">
              <div className="w-14 h-14 rounded-full bg-[#f6ece3] flex items-center justify-center text-2xl mb-4">
                🧠
              </div>

              <h3 className="text-xl font-bold text-[#3b2416] mb-3">
                Better Focus & Mood
              </h3>

              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Coffee may help improve memory, concentration, alertness,
            ...
            <div className="bg-white p-6 rounded-3xl shadow-lg hover:-translate-y-2 transition duration-300 border border-[#f1e4d8]">
              ...
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Research links regular coffee consumption with a lower
            ...
            <div className="bg-white p-6 rounded-3xl shadow-lg hover:-translate-y-2 transition duration-300 border border-[#f1e4d8]">
              ...
              <h4 className="text-xl font-bold text-[#3b2416] mb-3">
                Increased Energy
              </h4>

              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Coffee naturally boosts energy levels and endurance,
                helping people stay active and productive.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-lg hover:-translate-y-2 transition duration-300 border border-[#f1e4d8]">
              ...
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Many studies suggest coffee drinkers may enjoy longer,
                healthier lives with improved daily wellness.
              </p>
            </div>
