...
const sectionY = useTransform(scrollY, [0, 800], [40, 0]);
  ...
  return (
   ...
   <section className="relative w-full min-h-[60vh] md:min-h-screen overflow-hidden bg-[#2c1712] bg-[url('/bg-home-banner.webp')] bg-cover bg-center">
      ...
      <motion.img animate={{ y: [0, -30, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}src={coffeecup} alt="coffeecup" loading="lazy" className="hidden lg:block  absolute bottom-4 left-0 opacity-50" />
      <motion.div
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-full px-6">
        ...
        <motion.div
          ...
          className="text-[#c8a96a] text-2xl md:text-7xl mb-4 pt-52"
        >
          ✦
        </motion.div>
        ...
        <motion.p
          ...
          className="uppercase tracking-[0.3em] text-xs md:text-sm text-gray-300 mb-4"
        >
          The Story Of
        </motion.p>
        ...
        <motion.img
          ...
          className="mt-10 w-28 sm:w-36 md:w-96 lg:w-88  object-cover"
        />
      </div>
  ...
  <div className="absolute inset-0 overflow-hidden">
    ...
    <motion.div
      ...
      className="absolute inset-0 bg-[url('/section_img.webp')] bg-cover bg-center"
    /> 
