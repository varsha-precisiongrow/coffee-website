      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center w-full">
        ...
        <div className="pl-10 sm:pl-0">
          ...
          <motion.h2
            ...
            className="mt-5 text-xl md:text-3xl font-semibold text-gray-700 leading-snug italic"
          >
          CRAFTED FOR COFFEE {" "}

            <span className="relative inline-block text-[#4B2E2B] font-extrabold uppercase italic">
                  LOVERS

            <img
              src={redline}
              alt="brush" loading="lazy"
              className="absolute left-1/2 top-full -translate-x-1/2 -mt-2 w-[180px] md:w-[220px] pointer-events-none"
            />
          </span>
        ...
        <motion.p initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
            className="mt-5 text-gray-700 leading-snug text-lg ">
          Discover the rich aroma, bold flavors, and timeless artistry behind every perfect cup.
          From bean to brew, we bring passionate coffee lovers closer to the true craft of coffee.
        </motion.p>
        ...
        <button className="relative px-2 py-4 font-semibold text-white rounded-xl overflow-hidden group ">
          ...
          <motion.div
            ...
            className="mt-10 flex gap-10 text-gray-800"
          >
        ...
        >
          <img  src={cup} alt="Coffee" loading="lazy"
            className="w-[280px] md:w-[400px] lg:w-[500px] object-contain animate-[float_8s_ease-in-out_infinite]" />
        </motion.div>
...
<section className="w-full px-6 md:px-12 lg:px-20 py-16 bg-[url('/bg-1.webp')] bg-cover bg-center bg-no-repeat overflow-hidden">
      <div className="max-w-5xl mx-auto">     
        <motion.h3
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#d4a373] text-center leading-snug"
        >
          MYSTICAL BEGINNING OF COFFEE IN SOUTH INDIA
        </motion.h3>
        ...
        <motion.div className="text-white text-sm md:text-base lg:text-lg leading-relaxed space-y-5 text-justify lg:col-span-8" >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Coffee soon flourished in this region, filling the surroundings with
            its blooms and fragrance. Today, the Chikmagalur region is considered
