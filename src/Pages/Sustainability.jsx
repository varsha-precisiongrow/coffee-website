    ...
    <div className="relative w-full">
      ...
      <section className="relative w-full h-[90vh] overflow-hidden">
        ...
        <div className="max-w-4xl text-white">
         <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase leading-tight mb-6"
            >
          ...
          >
            At Coffee Institute, sustainability is at the heart of every cup.
            From ethically sourced beans to eco-friendly packaging, we are
            committed to creating a better future for coffee lovers and the
            planet.
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-1/2 z-50 pointer-events-none">
          <img
            src={stem}
            alt="coffee-stem" loading="lazy"
            className="w-32 md:w-96 drop-shadow-xl"
          />
        </div>
 {/* =================-------------------------------------- SECTION 2  --------------------------------------------------------================= */}
        <SusSection2 />
